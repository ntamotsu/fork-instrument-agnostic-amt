...
| Date | Update |
| --- | --- |
| 2026-09-02 | 🐍 Made tsumugi installable as a dependency of other Python projects, added the reusable `Transcriber` and `VelocityEstimator` APIs, and fixed velocity inference for short final audio windows. |
